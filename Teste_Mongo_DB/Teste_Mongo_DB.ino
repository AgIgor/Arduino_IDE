...
const char* apiUrl = "https://sa-east-1.aws.data.mongodb-api.com/app/data-zkoyd/endpoint/data/v1/action/find";
const char* apiKey = "jizTrVq2xlVIwtxOH5UoeOmkbdSpivNGv9UtvF32AqlAYRsPrPgCqELuQDqTL4Ud";
...
// const char* ssid = "VIVOFIBRA-9501";
// const char* password = "rgw7ucm3GT";
// const char* apiUrl = "https://sa-east-1.aws.data.mongodb-api.com/app/devicesync-xvtdd/endpoint/find_last?db=esp32&collection=CHIP_ID_0005&limit=1&api_key=ghQQuNqO9JwUPVQEtrygLE4rDKaahH8CRkWG0oM6d2b10fMhZtEOAtwUnKSMC9Y8";
// const char* apiKey = "ghQQuNqO9JwUPVQEtrygLE4rDKaahH8CRkWG0oM6d2b10fMhZtEOAtwUnKSMC9Y8";
...
// void loop() {
//   // O loop principal pode ser vazio ou conter outras operações
//   makeApiRequest();
//   delay(70000);
// }
...
//   http.addHeader("api-key", String(apiKey));

//   // Configurar dados para a requisição (se necessário)
//   // Exemplo de dados JSON:
//   // String jsonData = "{\"key\":\"value\"}";
//   // http.addHeader("Content-Length", String(jsonData.length()));

//   // Iniciar a conexão com a API
//   int httpResponseCode2 = http.begin(client, url);

//   // Enviar a requisição GET ou POST (dependendo da sua API)
...
// const char *base_rest_url = "https://sa-east-1.aws.data.mongodb-api.com/app/devicesync-xvtdd/endpoint/";
...
//   http.addHeader("Content-Type", "application/json");
//   http.addHeader("api-key", "ghQQuNqO9JwUPVQEtrygLE4rDKaahH8CRkWG0oM6d2b10fMhZtEOAtwUnKSMC9Y8");
//   http.GET();
